...
<link rel="stylesheet" href="{{asset('/css/fonts/ionicons.css')}}">
<link rel="stylesheet" href="{{asset('/css/fonts/linearicons.css')}}">
<link rel="stylesheet" href="{{asset('/css/fonts/open-iconic.css')}}">
<link rel="stylesheet" href="{{asset('/css/fonts/pe-icon-7-stroke.css')}}">
<link rel="stylesheet" href="{{asset('/css/fonts/feather.css')}}">
...
<link rel="stylesheet" href="{{asset('/libs/flot/flot.css')}}">